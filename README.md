...
- Separate AI source and verbose source log outputs; see [AI Source Format v1](docs/ai-source-format.en.md) for the implemented thread format, `/new`, and command policy.
